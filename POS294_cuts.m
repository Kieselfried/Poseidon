...
hold on
% Konturlinien hervorheben
[C h]=contour(Xs,Ys(174,:),Ts',s_line_t,'k','linewidth',3);
...
hold on
% Konturlinien hervorheben
[C h]=contour(Xs,Ys(174,:),Ss',s_line_s,'k','linewidth',2);
% Konturlinien beschriften
hl=clabel(C,h);
set(hl,'FontSize',10,'FontWeight','demi','color','k');
% Box als Hintergrund für Label malen
...
filename = strcat ('POS294_gesamt.pdf');
...
%% Als PDF Abspeichern
filename = strcat ('POS294_cut_',num2str(Xs(Start(Station))),'_to_',num2str(Xs(End(Station))),'.pdf');
