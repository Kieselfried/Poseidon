...
% Stationen bei
Start = [1  36 53 95 100 116 126 138 152];
End   = [35 52 94 99 102 125 136 151 167];
...
hold on
% Konturlinien hervorheben
[C h]=contour(Xs,Ys(50,:),Ts',s_line_t,'k','linewidth',3);
...
hold on
% Konturlinien hervorheben
[C h]=contour(Xs,Ys(50,:),Ss',s_line_s,'k','linewidth',2);
% Konturlinien beschriften
hl=clabel(C,h);
set(hl,'FontSize',10,'FontWeight','demi','color','k');
% Box als Hintergrund für Label malen
...
filename = strcat ('POS303_gesamt.pdf');
...
%% Als PDF Abspeichern
filename = strcat ('POS303_cut_',num2str(Xs(Start(Station))),'_to_',num2str(Xs(End(Station))),'.pdf');
